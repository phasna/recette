...
- [GUIDE_DEBUG_FAVORIS.md](./guides/features/GUIDE_DEBUG_FAVORIS.md) - Debug des favoris
...
- [GUIDE_PAGES_STRUCTURE.md](./guides/navigation/GUIDE_PAGES_STRUCTURE.md) - Structure des pages
...
#### 🚀 Scripts Utilitaires (`tests/scripts/`)
